...
import { MatButtonModule, MatCardModule, MatDialogModule, MatExpansionModule, MatFormFieldModule, MatInputModule, MatToolbarModule } from '@angular/material';
...
@NgModule({
  declarations: [DashboardComponent, LoginComponent, HeaderComponent, AppComponent, NoteviewComponent, NotetakerComponent, NoteComponent, EditnoteviewComponent, DialogMaterialComponent,],
